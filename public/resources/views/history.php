<x-layouts.mainLayout>
    ...
    <x-slot:pagetitle> <title> XIth Parachute Battalion History</title></x-slot:pagetitle>
    ...
    <x-slot:bodyclass>
        {{--<body class="bg-[#FDFDFC] bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-start lg:justify-center min-h-screen flex-col">--}}
...
<div class="container">
    ...
    <div class="enclosed"><i style="padding:10px; font-size: 2em" class='fa fa-calendar'></i>
        ...
        <div class="enclosed"><i style="padding:10px; font-size: 2em" class='fa fa-home'></i>
    ...
    <div class="enclosed"><img src="{{ asset('images/parachute.svg') }}" style="height:30px; margin: 10px" alt="Parachute Icon">
        ...
        <div class="container">
            <div class="officersbatthist">
                <img src="{{ asset('images/OfficersofTheXIth.jpg') }}" class="officersbatt" style="float:right">
